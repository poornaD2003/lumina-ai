...
const PRODUCT_CATALOG = [
  // ── Gaming Laptops ────────────────────────────────────────────────────────
  { name: 'ASUS ROG Strix G16', brand: 'ASUS', category: 'Gaming Laptop', processor: 'Intel Core i7-13650HX', ram: '16GB DDR5', storage: '512GB NVMe SSD', displaySize: '16"', unitPrice: 420_000, costRatio: 0.88, stock: 12, reorder: 3, warranty: 24 },
  { name: 'Lenovo Legion Pro 5', brand: 'Lenovo', category: 'Gaming Laptop', processor: 'AMD Ryzen 7 7745HX', ram: '32GB DDR5', storage: '1TB NVMe SSD', displaySize: '16"', unitPrice: 595_000, costRatio: 0.88, stock: 8, reorder: 3, warranty: 24 },
  { name: 'MSI Raider GE76', brand: 'MSI', category: 'Gaming Laptop', processor: 'Intel Core i9-12900HX', ram: '32GB DDR5', storage: '2TB NVMe SSD', displaySize: '17.3"', unitPrice: 690_000, costRatio: 0.87, stock: 4, reorder: 2, warranty: 24 },
  { name: 'Acer Predator Helios 300', brand: 'Acer', category: 'Gaming Laptop', processor: 'Intel Core i7-12700H', ram: '16GB DDR4', storage: '512GB NVMe SSD', displaySize: '15.6"', unitPrice: 380_000, costRatio: 0.87, stock: 6, reorder: 3, warranty: 12 },
  { name: 'HP Omen 16', brand: 'HP', category: 'Gaming Laptop', processor: 'AMD Ryzen 7 6800H', ram: '16GB DDR5', storage: '1TB NVMe SSD', displaySize: '16.1"', unitPrice: 459_000, costRatio: 0.87, stock: 7, reorder: 3, warranty: 12 },
  // ── Ultrabooks ────────────────────────────────────────────────────────────
  { name: 'MacBook Air M2', brand: 'Apple', category: 'Ultrabook', processor: 'Apple M2 (8-core CPU)', ram: '8GB Unified', storage: '256GB SSD', displaySize: '13.6"', unitPrice: 283_499, costRatio: 0.84, stock: 18, reorder: 5, warranty: 12 },
  { name: 'MacBook Air M3 15"', brand: 'Apple', category: 'Ultrabook', processor: 'Apple M3 (8-core CPU)', ram: '16GB Unified', storage: '512GB SSD', displaySize: '15.3"', unitPrice: 339_000, costRatio: 0.85, stock: 10, reorder: 4, warranty: 12 },
  { name: 'Dell XPS 13', brand: 'Dell', category: 'Ultrabook', processor: 'Intel Core i7-1360P', ram: '16GB LPDDR5', storage: '512GB NVMe SSD', displaySize: '13.4"', unitPrice: 510_000, costRatio: 0.86, stock: 9, reorder: 4, warranty: 12 },
  { name: 'LG Gram 14', brand: 'LG', category: 'Ultrabook', processor: 'Intel Core i7-1360P', ram: '16GB LPDDR5', storage: '512GB NVMe SSD', displaySize: '14"', unitPrice: 615_954, costRatio: 0.85, stock: 7, reorder: 3, warranty: 12 },
  { name: 'Lenovo ThinkPad X1 Carbon', brand: 'Lenovo', category: 'Ultrabook', processor: 'Intel Core i7-1365U', ram: '16GB LPDDR5', storage: '512GB NVMe SSD', displaySize: '14"', unitPrice: 88_500, costRatio: 0.86, stock: 8, reorder: 3, warranty: 36 },
  // ── Business Laptops ──────────────────────────────────────────────────────
